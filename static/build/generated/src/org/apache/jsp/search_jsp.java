  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("              ");
            ...
            ResultSet rs=DB.executeQuery("select * from book where bname like '%"+request.getParameter("t1")+"%'");
            while(rs.next())
                               {
      ...
      out.write("</td>\n");
      out.write("                    <td><a href=\"cartact.jsp?id=");
      out.print(rs.getString("bookid"));
      out.write("&sid=");
      out.print(request.getParameter("shopid"));
