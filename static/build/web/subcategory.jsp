    ...
    <body>
        ...
        <div class="welcome" id="video">
            <div class="container">
                ...
                <div class="w3_tittle"><h3 class="agile-tittle">SubCategory</h3> <div class="line-style"><span></span></div></div>
                <div class="w3-agile-top-info">	
                    <div class="w3-welcome-grids">
                        <div class="col-md-7 w3-welcome-left">

                            <p>  <form action="subcategoryaction.jsp">
                                <table>
                                    ...
                                    <tr><td>SUB-CATEGORY NAME:</td>
                                        <td><input type="text" name="subname"/></td></tr>
                                      <tr><td>&nbsp;</td></tr>
            ...
            <%
            ResultSet rs1=DB.executeQuery("select subid,subname,bookcategory.catname from subcategory inner join bookcategory on subcategory.catid=bookcategory.catid ");
            
            while(rs1.next())
                               {
                %>
                <tr>
                    <td><%=rs1.getString("subname")%> </td>
                    <td><%=rs1.getString("catname")%> </td>
                    <td>
                        <a href="delsubcategory.jsp?id=<%=rs1.getString("subid")%>">DELETE</a>
                    </td></tr>
                <%
            }
            %>
