    ...
    <body>
        ...
        <div class="welcome" id="video">
            <div class="container">
                ...
                <div class="w3_tittle"><h3 class="agile-tittle">Language</h3> <div class="line-style"><span></span></div></div>
                <div class="w3-agile-top-info">	
                    <div class="w3-welcome-grids">
                        <div class="col-md-7 w3-welcome-left">

                            <p>  <form action="languageaction.jsp">
            <table>
                <tr><td>LANGUAGE :</td>
                    <td><input type="text" name="lang"/></td></tr>
