    ...
    <body>
        ...
        <div class="welcome" id="video">
            <div class="container">
                ...
                <div class="w3_tittle"><h3 class="agile-tittle">Publisher</h3> <div class="line-style"><span></span></div></div>
                <div class="w3-agile-top-info">	
                    <div class="w3-welcome-grids">
                        <div class="col-md-7 w3-welcome-left">

                            <p>    <form action="publisheraction.jsp">
                                <table>
                           
                                    <tr><td>PUBLISHER NAME :</td>
                                        <td><input type="text" name="pubname"/></td></tr>
                                    <tr><td>ADDRESS :</td>
                                        <td><textarea name="address" cols="25" rows="5" style="border-color: black"></textarea></td></tr>
                                    <tr><td>PHONE NO.</td>
