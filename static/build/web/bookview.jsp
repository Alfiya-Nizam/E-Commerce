    ...
    <body>
        ...
        <div class="welcome" id="video">
            ...
            while(rs.next())
                ...
                %>
                <tr>
                    <td><img src="IUploads/<%=rs.getString("img")%>" width="150" height="100"/></td>
                    <td><%=rs.getString("bname")%> </td>
                    <td><%=rs.getString("catid")%></td>
                    <td><%=rs.getString("subid")%> </td>
                    <td><%=rs.getString("lang")%> </td>
                    <td><%=rs.getString("author")%> </td>
                    <td><%=rs.getString("pubid") %></td>
                    <td><%=rs.getString("isbno") %></td>
                    <td><%=rs.getString("price") %></td>
                    <td><%=rs.getString("stock") %></td>
                    <td><%=rs.getString("desc") %></td>
                    <td>
                        <a href="delbook.jsp?id=<%=rs.getString("bookid")%>">Delete</a>
                    </td>   
                      <td>
                        <a href="upbook.jsp?id=<%=rs.getString("bookid")%>&bn=<%=rs.getString("bname")%>&st=<%=rs.getString("stock")%>">Update Stock</a>
                    </td>
                 </tr>
                <%
            }
