...
<html lang="zxx">
    ...
    <body>
        ...
        <div class="welcome" id="video">
            ...
            <%
                ResultSet rs = DB.executeQuery("select * from book inner join orders on orders.pid=book.bookid where book.shopid=" + session.getAttribute("uid") + " ");
                while (rs.next()) {
            %>
            <tr>
                ...
                <td><a href="del.jsp?id=<%=rs.getString("oid")%>">Delivered</a></td>
                <%}%>
            </tr>
            <%
                }
