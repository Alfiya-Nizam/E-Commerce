    ...
    <body>
                    ...
                    <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
                        <nav>
                            <ul class="nav navbar-nav">
                              <li> <a href="categoryview_1.jsp">BOOK CATEGORIES</a></li>

                                <li><a href="bookview.jsp">BOOK DETAILS</a></li>
        ...
        <div class="welcome" id="video">
            <div class="container">
                ...
                <div class="w3_tittle"><h3 class="agile-tittle">BOOK ENTRY</h3> <div class="line-style"><span></span></div></div>
                <div class="w3-agile-top-info">	
                    <div class="w3-welcome-grids">
                        <div class="col-md-7 w3-welcome-left">

                            <p>   <form action="bookaction.jsp"><table>
            
                <tr><td>BOOK NAME :</td>
                    <td><input type="text" name="bname"/></td></tr>
                <tr><td>CATEGORY :</td>
                    <td><input type="text" name="category" value="<%=request.getParameter("id")%>" readonly="1"/></td></tr>
                <tr><td>SUB-CATEGORY :</td>
                    <td><select name="subcategory">
                             <%
                    ResultSet rs1=DB.executeQuery("select * from subcategory where catid='"+request.getParameter("id")+"'");
                    while(rs1.next())
                                               {
                        %>
                        <option value="<%=rs1.getString("subid")%>"><%=rs1.getString("subname")%></option>
                <%
                               }
                    %>
                        </select></td></tr>
                <tr><td>LANGUAGE :</td>
                    ...
                    while(rs2.next())
                                               {
                        %>
                        <option value="<%=rs2.getString("lang")%>"><%=rs2.getString("lang")%></option>
                <%
                               }
                            %>
                    </td></tr>
                    ...
                    while(rs3.next())
                                               {
                        %>
                        <option value="<%=rs3.getString("pubid")%>"><%=rs3.getString("pubname")%></option>
                <%
                               }
                            %>  
                        </td></tr>
                          <tr><td>ISB NO. :</td>
                              <td><input type="text" name="isbno" pattern="[0-9]+"/></td></tr>
                          <tr><td>PRICE :</td>
                              <td><input type="text" name="price"/></td></tr>
                          <tr><td>STOCK AVAILABLE :</td>
                              <td><input type="text" name="stock" pattern="[0-9]+"/></td></tr>
                          <tr><td>DESCRIPTION </td>
                              <td><textarea name="desc" cols="25" rows="5" style="border-color: #000000; color: black"></textarea></td></tr>
