    ...
    <body>
        ...
        <div class="welcome" id="video">
            <div class="container">
                ...
                <div class="w3_tittle"><h3 class="agile-tittle">E-Books</h3> <div class="line-style"><span></span></div></div>
                <div class="w3-agile-top-info">	
                    <div class="w3-welcome-grids">
                        <div class="col-md-7 w3-welcome-left">

                            <p>  <form action="ebaction.jsp">
            <table><tr>
                ...
                <tr><td>&nbsp;</td></tr>
                <tr>
                    <td> Synopsis</td><td><textarea rows="5" cols="20" name="t2" style="border-color: #660000;color: black"></textarea></td>
                </tr>
        ...
        <br/>
            ...
            <%
                ResultSet rs = DB.executeQuery("select * from ebook");
                while (rs.next()) {

            %>
            <tr>
                <td><%=rs.getString("ebt")%> </td>
                <td><%=rs.getString("synopsis")%> </td>
                
              
                <td><a href="delebb.jsp?id=<%=rs.getString("ebid")%>">Delete</a></td>
            </tr>
            <%}%>
        </table>
