    ...
    <body>
        ...
        <div class="welcome" id="video">
            <div class="container">
                ...
                <div class="w3_tittle"><h3 class="agile-tittle">Books Ordered</h3> <div class="line-style"><span></span></div></div>
                    ...
                    <div class="w3-welcome-grids">
                        <div >
                            ...
                            <table border="1">
                                ...
                                <%
                                System.out.println("select * from book inner join orders on orders.pid=book.bookid where orders.uid=" + session.getAttribute("uid"));
                                    ResultSet rs = DB.executeQuery("select * from book inner join orders on orders.pid=book.bookid where orders.uid=" + session.getAttribute("uid"));
                                    while (rs.next()) {
                                %>
                                <tr>
