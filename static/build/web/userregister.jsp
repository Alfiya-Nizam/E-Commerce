                ...
                <div class="w3-agile-top-info">	
                    <div class="w3-welcome-grids">
                        <div class="col-md-7 w3-welcome-left">
                            ...
                            <p> <form action="useraction.jsp"> <table> <tr>

                                    <tr>  <td> NAME : </td>
                                        <td> <input type="text" name="uname" pattern="[A-Z a-z]+"/></td> </tr>
                                    <tr><td>&nbsp;</td></tr>
                                    <tr> <td>DATE OF BIRTH : </td>
                                        <td><input type="date" name="dob"/></td></tr>
                                    <tr><td>&nbsp;</td></tr>
                                    <tr> <td>ADDRESS : </td>
                                        <td><textarea name="addr" cols="20" rows="5" style="border-color: #660000;color: black"></textarea></td></tr>
                                    <tr><td>&nbsp;</td></tr>
                                    <tr><td>PHONE NO. :</td>
