    ...
    <body>
        ...
        <div class="welcome" id="video">
            <div class="container">
                ...
                <div class="w3_tittle"><h3 class="agile-tittle">eBooks</h3> <div class="line-style"><span></span></div></div>
                    ...
                    <div class="w3-welcome-grids">
                        <div >
                            ...
                            <table >
                                <tr>
                                    <th>Title</th>
                                    <td>&nbsp;</td><td><%=rs.getString("ebt")%> </td>
                                   

                                </tr>
                                <tr>
                                    <th>Synopsis</th><td>&nbsp;</td>
                                    <td><%=rs.getString("synopsis")%> </td>
                                </tr>
                                <tr>
                                    <td><div class="w3l-button">
                                            <a href="pay_1.jsp?id=<%=rs.getString("ebid")%>" class="hvr-underline-from-center">READ</a>						
                                        </div></td>
