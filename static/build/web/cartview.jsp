    ...
    <body>
        ...
        <div class="welcome" id="video">
            <div class="container">
                ...
                <div class="w3_tittle"><h3 class="agile-tittle">Cart</h3> <div class="line-style"><span></span></div></div>
                <div class="w3-agile-top-info">	
                    <div class="w3-welcome-grids">
                        <div >
                            ...
                            <p>  
                                <%
                                    ResultSet rs1 = DB.executeQuery("select * from cart where uid=" + session.getAttribute("uid"));
                                    if (rs1.next()) {
                                %>
                            <form action="buy.jsp">
                                <table border="1">
                                    ...
                                    <%
                                        ResultSet rs = DB.executeQuery("select * from cart where uid=" + session.getAttribute("uid"));
                                        while (rs.next()) {
                                    %>
                                    <tr>
                                        <td><%=rs.getString("bid")%> </td>
                                        <%
                                            ResultSet t = DB.executeQuery("select sname from shop where shopid=" + rs.getString("sid"));
                                            t.next();

                                        %>
                                        <td><%=t.getString("sname")%> </td>
                                        <td>
                                            <input type="number" name="t1<%=rs.getString("cid")%>"/>   
                                        </td></tr>
                                        <%
                                            }
                                        %>
                                    <tr><td colspan="3"><input type="submit" value="CHECKOUT"/></td></tr>
                                </table>
                            </form>
                            <%} else {%>
                            <h3>No Cart Items</h3>
