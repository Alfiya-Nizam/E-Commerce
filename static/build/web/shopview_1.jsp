    ...
    <body>
        ...
        <div class="welcome" id="video">
            <div class="container">
                ...
                <div class="w3_tittle"><h3 class="agile-tittle">Shop</h3> <div class="line-style"><span></span></div></div>
            ...
            <tr>
                ...
                <td><%=rs.getString("licno")%> </td>
                <td>
                    <a href="bookview_1_1.jsp?id=<%=rs.getString("shopid")%>">BOOKS</a>
                </td>
                <td>
                    <a href="order.jsp?id=<%=rs.getString("shopid")%>">BOOKS ORDERED</a>
                </td>
            </tr>
            <%
                }
