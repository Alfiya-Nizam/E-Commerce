    ...
    <body>
        ...
        <div class="welcome" id="video">
            <div class="container">
                ...
                <div class="w3_tittle"><h3 class="agile-tittle">BOOK VIEW</h3> <div class="line-style"><span></span></div></div>
                <div class="w3-agile-top-info">	
                    <div class="w3-welcome-grids">
                        <div class="col-md-7 w3-welcome-left">

                            <p> <form action="upbaction.jsp"><table>
                <tr><td>BOOK CODE:</td>
                    <td><input type="text" name="bookid" value="<%=request.getParameter("id")%>" readonly=""/></td></tr>
                 <tr><td>BOOK NAME</td>
                     <td><input type="text" name="bname" value="<%=request.getParameter("bn")%>" readonly=""/></td></tr>
               
                          <tr><td>STOCK AVAILABLE :</td>
                              <td><input type="text" name="stock" value="<%=request.getParameter("st")%>"/></td></tr>
