    ...
    <body>
        ...
        <div class="welcome" id="video">
            <div class="container">
                ...
                <div class="w3_tittle"><h3 class="agile-tittle">Search</h3> <div class="line-style"><span></span></div></div>
                        ...
                        <div >
                            ...
                            <%
                                ...
                                if (request.getParameter("t1") == "" || request.getParameter("t1") == null) {
                                    rs = DB.executeQuery("select * from book inner join shop on shop.shopid=book.shopid ");
                                } else {
                                    rs = DB.executeQuery("select * from book inner join shop on shop.shopid=book.shopid where bname like '%" + request.getParameter("t1") + "%' or sname like '%"+request.getParameter("t1")+"%'");
                                }
                                while (rs.next()) {
                            %>
                            <table>
                                <tr> <td rowspan="8">
                                    ...
                                    <td></td><td>&nbsp;</td> <td rowspan="8"> <div class="w3l-button">
                                            <a href="cartact.jsp?id=<%=rs.getString("bookid")%>&sid=<%=rs.getString("shopid")%>" class="hvr-underline-from-center">Add to Cart</a>						
                                        </div></td> </tr>
                                <tr>  <th>CATEGORY  &nbsp;&nbsp;&nbsp;</th>  <td><%=rs.getString("catid")%></td> <th>SUB-CATEGORY  &nbsp;&nbsp;&nbsp;</th>  <td><%=rs.getString("subid")%> </td></tr>

                                <tr>   <th>LANGUAGE &nbsp;&nbsp;&nbsp;</th>  <td><%=rs.getString("lang")%> </td></tr>
                                <tr>   <th>AUTHOR &nbsp;&nbsp;&nbsp;</th> <td><%=rs.getString("author")%> </td> <th>PUBLISHER  &nbsp;&nbsp;&nbsp;</th> <td><%=rs.getString("pubid")%></td></tr>
                                ...
                                <tr>   <th>SHOP DETAILS &nbsp;&nbsp;&nbsp;</th>
                                    <td colspan="3"><%=rs.getString("sname")%>,<%=rs.getString("address")%>
                                    ,<%=rs.getString("phno")%>,<%=rs.getString("mail")%></td></tr>
